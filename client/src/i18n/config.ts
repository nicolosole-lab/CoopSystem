...
const enTranslations = {
  ...
  "clients": {
    ...
    "details": {
      ...
      "budget": "Budget",
      "noCompensationRecords": "No compensation records found",
      "notes": "Notes",
...
const itTranslations = {
  ...
  "clients": {
    ...
    "details": {
      "title": "Dettagli Assistito",
      "personalInformation": "Informazioni Personali",
      "contactInformation": "Informazioni di Contatto",
      "budgetInformation": "Informazioni Budget",
      ...
      "remaining": "Rimanente",
      "assignedCollaborators": "Collaboratori Assegnati",
      "monthlyBudget": "Budget Mensile",
      "emergencyContact": "Contatto di Emergenza",
      "serviceStatistics": "Statistiche Servizio",
      "totalHours": "Ore Totali",
      "totalCost": "Costo Totale",
      "serviceLogs": "Registri Servizio",
      "recordInformation": "Informazioni Record",
      "created": "Creato",
      "lastUpdated": "Ultimo Aggiornamento",
      "clientId": "ID Assistito",
      "addCollaborator": "Aggiungi Collaboratore",
      "selectStaffMember": "Seleziona Membro Staff",
      "chooseStaffMember": "Scegli un membro dello staff",
      ...
      "external": "Esterno",
      "staff": "Staff",
      "staffNotFound": "Membro dello staff non trovato",
      "confirmRemoveCollaborator": "Sei sicuro di voler rimuovere questo collaboratore?",
      "unknownStaff": "Staff Sconosciuto",
      "pending": "In Attesa",
      "approved": "Approvato",
      "paid": "Pagato",
      "clientOwes": "Cliente Deve",
      "budget": "Budget",
      "noCompensationRecords": "Nessun record di compenso trovato",
      "notes": "Note",
